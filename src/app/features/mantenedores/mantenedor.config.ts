...
export const MANTENEDORES_CONFIG: MantenedorConfig[] = [
  ...
  // ── Tipos de Flete ───────────────────────────────────────────────────────
  {
    ...
    description: 'Clasificación de los tipos de movimiento de flete.',
    ...
    camposCrear: [
      { key: 'sap_codigo',      label: 'Código SAP',     tipo: 'text', required: true, placeholder: 'Cód. en SAP' },
  ...
  // ── Folios ───────────────────────────────────────────────────────────────
  {
    ...
    description: 'Folios de agrupación de fletes para facturación.',
    idField: 'id_folio',
    permiso: 'folios',
    tipoEspecial: 'folios',
    columnas: [
