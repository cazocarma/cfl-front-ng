...
export const MANTENEDORES_CONFIG: MantenedorConfig[] = [
  ...
  // ── Especies ──────────────────────────────────────────────────────────────
  {
    ...
    description: 'Tipos de fruta, producto o material transportado.',
    idField: 'id_especie',
    permiso: 'especies',
    columnas: [
      { key: 'glosa', label: 'Nombre', tipo: 'text' },
    ],
    camposCrear: [
      { key: 'glosa', label: 'Nombre', tipo: 'text', required: true, placeholder: 'Ej: Ciruela, Manzanas, Uva' },
    ],
  },
