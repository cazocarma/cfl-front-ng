    ...
    <div class="flex h-screen overflow-hidden bg-forest-50 font-sans">
      ...
      >
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-5 space-y-1">
          ...
          <p class="px-3 mb-2 text-[10px] font-bold uppercase tracking-widest text-forest-600">Administración</p>

          <a routerLink="/carga-entregas" class="nav-item" (click)="sidebarOpen.set(false)">
            <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
